...
export const Contacts = () => {
  return (
    <div className="contacts mt-16">
      ...
      <div className="lg-md:flex lg-md:gap-36">
        <div>
          ...
          <div className="socials">
            ...
            <a href="" target="_blank">
              <img
                src="/src/assets/icons/socials/whatsapp.svg"
                alt="whatsapp"
              />
            </a>
            <a href="" target="_blank">
              <img
                src="/src/assets/icons/socials/telegram.svg"
                alt="telegram"
              />
            </a>
            <a href="" target="_blank">
              <img src="/src/assets/icons/socials/tiktok.svg" alt="gmail" />
            </a>
            <a href="" target="_blank">
        ...
        <div className="map lg-md:flex-grow">
          <iframe
